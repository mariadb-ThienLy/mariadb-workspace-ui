import { g as w } from "./chartjs-plugin-trendline-BDw12kqS.js";
var f, b;
function v() {
  if (b) return f;
  b = 1;
  ...
  function y(e) {
    ...
    return r === "[object RegExp]" || r === "[object Date]" || O(e);
  }
  var m = typeof Symbol == "function" && Symbol.for, j = m ? Symbol.for("react.element") : 60103;
  function O(e) {
    return e.$$typeof === j;
  }
  function g(e) {
  ...
  function d(e, r, n) {
    ...
    return n.isMergeableObject(e) && i(e).forEach(function(t) {
      ...
      A(e, t) || (l(e, t) && n.isMergeableObject(r[t]) ? c[t] = p(t, n)(e[t], r[t], n) : c[t] = u(r[t], n));
    }), c;
  }
  function a(e, r, n) {
    ...
    return h ? c ? n.arrayMerge(e, r, n) : d(e, r, n) : u(r, n);
  }
  a.all = function(r, n) {
    if (!Array.isArray(r))

import { c as ne, g as Ur } from "./chartjs-plugin-trendline-BDw12kqS.js";
function te(oe) {
    ...
    (function(z) {
      ...
      return (function z(M, K, E) {
        ...
        function ae(l) {
          ...
          if (!y)
            return this.resolve([]);
          for (var x = new Array(y), L = 0, O = -1, P = new this(C); ++O < y; )
            $(l[O], O);
          return P;
          function $(J, k) {
            p.resolve(J).then(ie, function(X) {
              w || (w = !0, b.reject(P, X));
            });
            function ie(X) {
              x[k] = X, ++L === y && !w && (w = !0, b.resolve(P, x));
            }
          }
        }
        v.race = H;
        ...
        var D = "local-forage-detect-blob-support", W = void 0, N = {}, ae = Object.prototype.toString, H = "readonly", l = "readwrite";
        function p(e) {
        ...
        function We(e) {
          ...
          if (e)
            for (var o in e)
              r[o] = e[o];
          var a = N[r.name];
          a || (a = ge(), N[r.name] = a), a.forages.push(n), n._initReady || (n._initReady = n.ready, n.ready = Ye);
          var t = [];
          function i() {
            return v.resolve();
          }
          ...
          return v.all(t).then(function() {
            ...
            return r.db = s, k(r, n._defaultConfig.version) ? J(r) : s;
          }).then(function(s) {
              ...
              V(r._dbInfo, H, function(i, f) {
                ...
                try {
                  ...
                  c.onsuccess = function() {
                    var s = c.result;
                    s === void 0 && (s = null), pe(s) && (s = X(s)), a(s);
                  }, c.onerror = function() {
                    t(c.error);
                  };
                } catch (s) {
        ...
        function Ke(e, n, r) {
          ...
          var a = new v(function(t, i) {
            ...
            o.ready().then(function() {
              return f = o._dbInfo, ae.call(n) === "[object Blob]" ? w(f.db).then(function(u) {
                return u ? n : ie(n);
              }) : n;
            }).then(function(u) {
          ...
          if (!e.name)
            ...
            e.storeName ? a = i.then(function(f) {
              if (f.objectStoreNames.contains(e.storeName)) {
                ...
                return g.then(function(_) {
                  ...
                  for (var R = 0; R < s.length; R++) {
                    var S = s[R];
                    S._dbInfo.db = _, L(S._dbInfo);
                  }
                }).catch(function(_) {
                  throw (O(e, _) || v.resolve()).catch(function() {
                  }), _;
                });
              }
            }) : a = i.then(function(f) {
              ...
              return m.then(function(g) {
                ...
                throw (O(e, g) || v.resolve()).catch(function() {
                }), g;
              });
            });
          }
        ...
        var Q = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", ke = "~~local_forage_type~", _e = /^~~local_forage_type~([^~]+)~/, ee = "__lfsc__:", fe = ee.length, ue = "arbf", ce = "blob", be = "si08", we = "ui08", Ee = "uic8", Se = "si16", Ie = "si32", Re = "ur16", Ae = "ui32", De = "fl32", Ne = "fl64", Te = fe + ue.length, xe = Object.prototype.toString;
        function Be(e) {
        ...
        function er(e, n) {
          var r = "";
          if (e && (r = xe.call(e)), e && (r === "[object ArrayBuffer]" || e.buffer && xe.call(e.buffer) === "[object ArrayBuffer]")) {
            var o, a = ee;
            e instanceof ArrayBuffer ? (o = e, a += ue) : (o = e.buffer, r === "[object Int8Array]" ? a += be : r === "[object Uint8Array]" ? a += we : r === "[object Uint8ClampedArray]" ? a += Ee : r === "[object Int16Array]" ? a += Se : r === "[object Uint16Array]" ? a += Re : r === "[object Int32Array]" ? a += Ie : r === "[object Uint32Array]" ? a += Ae : r === "[object Float32Array]" ? a += De : r === "[object Float64Array]" ? a += Ne : n(new Error("Failed to get type for BinaryArray"))), n(a + se(o));
          } else if (r === "[object Blob]") {
            var t = new FileReader();
            t.onload = function() {
              var i = ke + e.type + "~" + se(this.result);
              n(ee + ce + i);
        ...
        function rr(e) {
          if (e.substring(0, fe) !== ee)
            return JSON.parse(e);
          var n = e.substring(Te), r = e.substring(fe, Te), o;
          if (r === ce && _e.test(n)) {
            var a = n.match(_e);
        ...
        function G(e, n, r, o, a, t) {
          e.executeSql(r, o, a, function(i, f) {
            f.code === f.SYNTAX_ERR ? i.executeSql("SELECT name FROM sqlite_master WHERE type='table' AND name = ?", [n.storeName], function(u, c) {
              c.rows.length ? t(u, f) : Ce(u, n, function() {
        ...
        function yr() {
          return !mr() || localStorage.length > 0;
        }
        function pr(e) {
          var n = this, r = {};
          if (e)
            for (var o in e)
              r[o] = e[o];
          return r.keyPrefix = Oe(e, n._defaultConfig), yr() ? (n._dbInfo = r, r.serializer = le, v.resolve()) : v.reject();
        }
        function gr(e) {
        ...
        function Ar(e, n) {
          ...
          var o = this, a;
          return e.name ? a = new v(function(t) {
            e.storeName ? t(Oe(e, o._defaultConfig)) : t(e.name + "/");
          }).then(function(t) {
        ...
        var Dr = {
          ...
          WEBSQL: dr,
          LOCALSTORAGE: Dr
        }, xr = [j.INDEXEDDB._driver, j.WEBSQL._driver, j.LOCALSTORAGE._driver], re = ["dropInstance"], ve = ["clear", "getItem", "iterate", "key", "keys", "length", "removeItem", "setItem"].concat(re), Br = {
          description: "",
          driver: xr.slice(),
          name: "localforage",
        ...
        function de() {
          for (var e = 1; e < arguments.length; e++) {
            ...
            if (n)
              for (var r in n)
                n.hasOwnProperty(r) && (Pe(n[r]) ? arguments[0][r] = n[r].slice() : arguments[0][r] = n[r]);
          }
          return arguments[0];
        }
        var Lr = (function() {
          function e(n) {
            ...
            for (var r in j)
              if (j.hasOwnProperty(r)) {
                ...
                this[r] = a, q[a] || this.defineDriver(o);
              }
            this._defaultConfig = de({}, Br), this._config = de({}, this._defaultConfig, n), this._driverSet = null, this._initDriver = null, this._ready = !1, this._dbInfo = null, this._wrapLibraryMethodsWithReady(), this.setDriver(this._config.driver).catch(function() {
            });
          }
          return e.prototype.config = function(r) {
            ...
            var t = new v(function(i, f) {
              try {
                ...
                for (var s = ve.concat("_initStorage"), d = 0, m = s.length; d < m; d++) {
                  var g = s[d], _ = !Tr(re, g);
                ...
                var R = function() {
                  for (var Z = function(Fr) {
                    return function() {
                      var Mr = new Error("Method " + Fr + " is not implemented by the current driver"), Me = v.reject(Mr);
                      return h(Me, arguments[arguments.length - 1]), Me;
                    };
                  }, he = 0, Pr = re.length; he < Pr; he++) {
                    var me = re[he];
                    r[me] || (r[me] = Z(me));
                  }
                };
                R();
                var S = function(Z) {
                  q[u] && console.info("Redefining LocalForage driver: " + u), q[u] = r, Fe[u] = Z, i();
                };
            ...
            var t = q[r] ? v.resolve(q[r]) : v.reject(new Error("Driver not found."));
            return I(t, o, a), t;
